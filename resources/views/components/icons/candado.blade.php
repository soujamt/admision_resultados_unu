...
<svg {{ $attributes }} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <path
        opacity="0.5"
    ...
    @if ($abierto)
        {{-- Arco abierto: estado habilitado / acción habilitar --}}
        <path
        ...
        />
    @else
        {{-- Arco cerrado: estado deshabilitado / acción deshabilitar --}}
        <path
